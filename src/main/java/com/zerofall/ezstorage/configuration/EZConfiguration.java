...
public class EZConfiguration extends SimpleConfigs {
    ...
    public static final ConfigEnum<SortMode> guiSortMode = new ConfigEnum<>(Reference.MOD_ID + ".guiSortMode", SortMode.AMOUNT, Reference.MOD_ID + ".guiSortMode");
    ...
    public EZConfiguration(String name, List<ConfigBase<?>> values) {
    ...
    static {
        ...
        List<ConfigBase<?>> gui = List.of(
            focusGuiInput, guiSortMode, guiSortOrder, guiSearchMode, guiSaveSearch, guiAutoRefill, guiSearchText, renderCraftingPreview
        );
        ...
        INSTANCE = new EZConfiguration(Reference.MOD_NAME, ALL_OPTIONS);
    }
}